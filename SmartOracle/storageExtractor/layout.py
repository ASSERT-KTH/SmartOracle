...
def extractStorageLayout(sol_file, contractName, compilerVersion, contractsPath, outputStorageFile=None):
    ...
    for compilation_unit in compilation_units:
        ...
        print(compilation_unit._storage.keys())
        storageLayout_dict =  dict(storage = compilation_unit._storage[contractName], types = compilation_unit._type_info[contractName])
    # except:
    #     print("slither analysis error")
    os.chdir(ori)
    if outputStorageFile is not None:
        with open(outputStorageFile, "w") as f:
            json.dump(storageLayout_dict, f)
...
if __name__ == "__main__":
    ...
    contractName = "QBridge"
    outputStorageFile = "/home/pc/disk1/sujzh3/invFuzz/slotExtractor_new/qubit/storageLayout.json"
    sol_file = "/home/pc/disk1/sujzh3/invFuzz/slotExtractor_new/qubit/contracts/contracts/bridge/QBridge.sol"
    extractStorageLayout(sol_file, contractName, version, outputStorageFile)